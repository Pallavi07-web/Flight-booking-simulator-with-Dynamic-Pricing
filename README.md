...
git clone [[https://github.com/YourUsername/flight-booking-simulator.git](https://github.com/YourUsername/flight-booking-simulator.git)](https://github.com/pallavi07-Web/Flight-Booking-Simulator-with-Dynamic-Pricing)
cd flight-booking-simulator

# Create and activate a virtual environment
python -m venv fapivenv
# On Windows
...
The database file (db_schema.sql) must be created and populated with the initial schema and sample flights.
...
(The UI will open automatically in your browser, typically at http://127.0.0.1:5500)
